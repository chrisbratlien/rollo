...
#@improv[:lead][:name => :a, :channel => 0, :test => @note_name_match, :simult => 1, :pov => (30..50)]
#@improv[:lead][:name => :b, :channel => 0, :test => @note_name_match, :simult => 1, :pov => (40..60)]
@improv[:lead][:name => :c, :channel => 0, :test => @note_name_match, :simult => 1, :pov => (50..70)]
@improv[:lead][:name => :d, :channel => 0, :test => @note_name_match, :simult => 1, :pov => (60..80)]
@improv[:lead][:name => :e, :channel => 0, :test => @note_name_match, :simult => 1, :pov => (70..90)]
